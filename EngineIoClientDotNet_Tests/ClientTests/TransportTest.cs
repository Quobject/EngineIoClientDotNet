...
namespace Quobject.EngineIoClientDotNet_Tests.ClientTests
{
    ...
    public class TransportTest : Connection
    {
        ...
        public void Uri()
        {
            ...
            options.Query = ImmutableDictionary<string, string>.Empty.Add("sid", "test");
        ...
        public void UriWithPort()
        {
            ...
            options.Port = 3000;
            var polling = new Polling(options);
            Assert.Contains("http://localhost:3000/engine.io?sid=test", polling.Uri());
        }
        ...
        public void HttpsUriWithDefaultPort()
        {
            ...
            options.Port = 443;
            var polling = new Polling(options);
            Assert.Contains("https://localhost/engine.io?sid=test", polling.Uri());
        }
        ...
        public void WsUri()
        {
            ...
            options.Secure = false;
            options.Query = ImmutableDictionary<string, string>.Empty.Add("transport", "websocket");
            options.TimestampRequests = false;
